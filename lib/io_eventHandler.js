...
function ioEventHandler(socket) {
	...
	socket.on('pi', (data) => socket.broadcast.emit('pi', data));
	socket.on('web', (data) => socket.broadcast.emit('web', data));
	socket.on('lora', (data) => socket.broadcast.emit('lora', data));
	socket.on('pi1h', (data) => socket.broadcast.emit('pi1h', data));
	socket.on('solar24h', (data) => socket.broadcast.emit('solar24h', data));
	socket.on('energy24h', (data) => socket.broadcast.emit('energy24h', data));
	socket.on('req', (data) => socket.broadcast.emit('req', data));
}
